...
Contruccion del dataset de entrenamiento del modelo
...
Se cubren las **4 tipologías de deepfake** definidas en 8.1.1 del documento:
...
## Estado actual (prueba con 500 imágenes)

| #   | Script                      | Estado        | Resultado                                 |
| --- | --------------------------- | ------------- | ----------------------------------------- |
| 01  | `01_descargar_ffhq.py`      | ✅ Completado | 500 PNG en `data/raw/real/`               |
| 02  | `02_generar_swaps.py`       | ✅ Completado | 109 fakes en `data/raw/fake_swap/`        |
| 03  | `03_generar_inpainting.py`  | ✅ Completado | 500 fakes en `data/raw/fake_inpainting/`  |
...
| 07  | `07_generar_sintesis.py`    | ✅ Completado | 500 fakes en `data/raw/fake_sintesis/`    |
| 08  | `08_generar_reenactment.py` | ✅ Completado | 500 fakes en `data/raw/fake_reenactment/` |

> **Nota sobre el paso 02:** De 500 imágenes reales solo 109 generaron swaps exitosos.
...
Qué hace: descarga el dataset FFHQ desde Kaggle y selecciona 500 imágenes
...
# Resultado esperado: 500 imágenes reales
```
...
- Tiempo estimado: 2–5 minutos para 500 imágenes con GPU
...
- Tiempo estimado: 5 segundos/imagen × 500 = ~90 minutos con RTX 4050
...
- Tiempo estimado: ~90 minutos para 500 imágenes con RTX 4050
...
- Tiempo estimado: menos de 2 minutos para 500 imágenes
- Salida: `data/raw/fake_reenactment/` y `data/raw/reenactment_log.json`

---

## Qué produce el el archivo
